...
app = Flask(__name__)
token = "MTE5NjAwMjAyNjg5MTUyMjEzOA.GQQQgK.i4TTUTsDBP9rqT_3BmYniUPMzPfIkR1a0pjcrE"
...
def scraping(data):
    container_channel_ID    = "1305088862413918270"
    node_channel_ID         = "1305089046275559455"
    traffic_channel_ID      = "1305148797248077854"
    nginx_channel_ID        = "1305350748103774309"
    apache_channel_ID       = "1305350777908363284"
